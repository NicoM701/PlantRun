  ...
  _renderSetup() {
    return html`
      <section class="setup">
        ...
        <p class="hint">Create the run basics now. Cultivar is the display name shown on this run. Add Breeder (and optional Strain) with Cultivar to refine the SeedFinder match.</p>
        <div class="row">
          <div class="field">
        ...
        <div class="row">
          <div class="field">
            ...
            <input class="input" .value=${this._setupForm.cultivar_name} placeholder="Displayed cultivar name (used for SeedFinder lookup)" @input=${(e) => this._setSetup("cultivar_name", e.target.value)} />
          </div>
          <div class="field">
